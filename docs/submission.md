...
Describe the entry as an enhancement of the official llama.cpp Android sample: reproducible Qwen GGUF preparation, automatic per-device thread tuning, thermal-aware UI inference measurements, and portable benchmark reports. Attribute llama.cpp, KleidiAI, and OpenMP; do not present them as newly authored components.
